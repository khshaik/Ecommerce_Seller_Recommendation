#!/bin/bash
# ==========================================================================================
# Seller Catalog ETL - Spark Submit Script (Run from root folder DSP_GA_2025em1100102_20112025)
# ==========================================================================================
#
# Purpose: Execute the Seller Catalog ETL pipeline using Spark, Hudi, and AWS SDKs.
#          This script runs the Seller Catalog ETL pipeline using Spark + Hudi + AWS SDK.
#
# Overview:
#   This script runs the ETL job that processes seller catalog data stored in Hudi tables.
...
#
# Reference
#   (.venv) UIOPYT@HQN473V4C2 DSP_GA_2025em1100102_20112025 % ./2025em1100102/ecommerce_seller_recommendation/s3/scripts/etl_seller_catalog_spark_submit.sh
#
...
echo "====================================================="
echo " 🚀 Running Seller Catalog ETL via Spark Submit"
echo "====================================================="
echo "Timestamp: $(date)"
echo "PWD: $(pwd)"
echo "-----------------------------------------------------"
