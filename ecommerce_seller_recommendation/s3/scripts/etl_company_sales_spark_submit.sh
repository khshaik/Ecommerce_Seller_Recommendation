#!/bin/bash
# ==========================================================================================
# Company Sales ETL - Spark Submit Script (Run from root folder DSP_GA_2025em1100102_20112025)
# ==========================================================================================
# 
# Purpose: Execute the Company Sales ETL pipeline using Spark, Hudi, and AWS SDKs.
#          This script runs the Company Sales ETL pipeline using Spark + Hudi + AWS SDK.
#
# Overview:
#   This script runs the ETL job that processes company sales data stored in Hudi tables.
...
#
# Overview:
#   The Company Sales ETL job:
#     ✔ Reads raw company sales data (Hudi snapshot or flat files)
...
#
# Reference
#   (.venv) UIOPYT@HQN473V4C2 DSP_GA_2025em1100102_20112025 % ./2025em1100102/ecommerce_seller_recommendation/s3/scripts/etl_company_sales_spark_submit.sh
#
...
echo "====================================================="
echo " 🚀 Running Company Sales ETL via Spark Submit"
echo "====================================================="
echo "Timestamp: $(date)"
echo "PWD: $(pwd)"
echo "-----------------------------------------------------"
